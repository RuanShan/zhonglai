    ...
    var runContainerHeight = function () {
        ...
        if ($windowWidth < 768) {
           mainNavigation.css('min-height', $windowHeight - $('body > .navbar').outerHeight());
					 ...
					 $('.main-content').css({'height':'auto','overflow-y':'auto'});
					 $('.pc-navigation').css({'height':'auto','overflow-y':'auto'});
        }else{
					mainContainer.css({'min-height':$(window).height()-48-$('.footer').outerHeight()});
					$('.main-content').css({'height':$(window).height()-48-$('.footer').outerHeight(),'overflow-y':'scroll'});
					$('.pc-navigation').css({'height': $('.main-content').outerHeight(),'overflow-y':'scroll'});
				}
    };
