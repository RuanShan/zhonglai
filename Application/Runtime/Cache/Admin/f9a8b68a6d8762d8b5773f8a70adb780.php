				...
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ol class="breadcrumb">
								...
								<li class="active">
									<?php echo ($column_data["name"]); ?>文章列表
								</li>
								<li class="search-box">
					...
					<div class="row">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									<div class="panel-tools">
										<a class="btn btn-xs btn-link" href="<?php echo U('Article/form',array('type'=>'add','column_id'=>I('column_id')));?>">
									...
									<table class="table table-striped table-bordered table-hover" id="sample-table-2">
										<thead>
											<tr>
												...
												<th width="160" class="center">发布时间</th>
                    	...
                    	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
												...
												<td class="center"><?php echo ($vo["post_time"]); ?></td>
												<td class="center"><?php echo ($vo["title"]); ?></td>
												<td class="center">
												<div class="visible-md visible-lg hidden-sm hidden-xs">
													<a href="<?php echo U('Article/form',array('type'=>'edit','column_id'=>$vo['column_id'],'id'=>$vo['id']));?>" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="修改"><i class="fa fa-edit"></i></a>
													<a href="<?php echo U('Article/delete',array('id'=>$vo['id']));?>"  onclick="if(confirm('确定删除?')==false)return false;" class="btn btn-xs btn-bricky tooltips" data-placement="top" data-original-title="删除"><i class="fa fa-times fa fa-white"></i></a>
												</div>
												</td>
