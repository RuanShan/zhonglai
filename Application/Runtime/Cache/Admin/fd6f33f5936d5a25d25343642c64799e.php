          ...
          <div class="pc-navigation">
			...
			<div class="main-content">
				<div class="container">
						...
						<div class="col-sm-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<form role="form" method="post" action="<?php echo U('Column/post');?>" class="form-horizontal" enctype="multipart/form-data">
										<div class="form-group">
											<label class="col-sm-2 control-label">
												栏目名称
											</label>
											<div class="col-sm-4">
												<input placeholder="请输入栏目名称" name="name" value="<?php echo ($data["name"]); ?>" class="form-control" type="text">
											</div>
										</div>
                    <div class="form-group">
											<label class="col-sm-2 control-label">
											...
											<div class="col-sm-4">
												<input placeholder="请输入英文名称" name="en_name" value="<?php echo ($data["en_name"]); ?>" class="form-control" type="text">
											</div>
										</div>
                    <div class="form-group">
											<label class="col-sm-2 control-label">
											...
											<div class="col-sm-4">
												<input placeholder="请输入其他英文名称" name="other_en" value="<?php echo ($data["other_en"]); ?>" class="form-control" type="text">
											</div>
										</div>
                    <div class="form-group">
											<label class="col-sm-2 control-label">
                    ...
                    <?php if(($data["pc_pic"]) != ""): ?><div class="form-group">
                    	<div class="col-sm-4 col-sm-offset-2">
                    		<img src="/Uploads/<?php echo ($data["pc_pic"]); ?>" width="200">
                      </div>
                    </div><?php endif; ?>
                    <div class="form-group">
											<label class="col-sm-2 control-label">
													...
													<div class="input-group">
														...
														<div class="input-group-btn">
															<div class="btn btn-light-grey btn-file">
																...
																<input type="file" name="pc_pic" class="file-input">
															</div>
                    ...
                    <?php if(($data["mob_pic"]) != ""): ?><div class="form-group">
                    	<div class="col-sm-4 col-sm-offset-2">
                    		<img src="/Uploads/<?php echo ($data["mob_pic"]); ?>" width="200">
                      </div>
                    </div><?php endif; ?>
                    <div class="form-group">
											<label class="col-sm-2 control-label">
													...
													<div class="input-group">
														...
														<div class="input-group-btn">
															<div class="btn btn-light-grey btn-file">
																<span class="fileupload-new"><i class="fa fa-folder-open-o"></i> 选择文件</span>
																<span class="fileupload-exists"><i class="fa fa-folder-open-o"></i> 重新选择</span>
																<input type="file" name="mob_pic" class="file-input">
															</div>
															<a href="#" class="btn btn-light-grey fileupload-exists" data-dismiss="fileupload">
																<i class="fa fa-times"></i> 删除选择
															</a>
                    ...
                    <?php if(($data["mob_title_pic"]) != ""): ?><div class="form-group">
                    	<div class="col-sm-4 col-sm-offset-2">
                    		<img src="/Uploads/<?php echo ($data["mob_title_pic"]); ?>" width="200">
                      </div>
                    </div><?php endif; ?>
                    <div class="form-group">
											<label class="col-sm-2 control-label">
													...
													<div class="input-group">
														...
														<div class="input-group-btn">
															<div class="btn btn-light-grey btn-file">
																<span class="fileupload-new"><i class="fa fa-folder-open-o"></i> 选择文件</span>
																<span class="fileupload-exists"><i class="fa fa-folder-open-o"></i> 重新选择</span>
																<input type="file" name="mob_title_pic" class="file-input">
															</div>
															<a href="#" class="btn btn-light-grey fileupload-exists" data-dismiss="fileupload">
																<i class="fa fa-times"></i> 删除选择
															</a>
                    ...
                    <?php if(($data["thumb"]) != ""): ?><div class="form-group">
                    	<div class="col-sm-4 col-sm-offset-2">
