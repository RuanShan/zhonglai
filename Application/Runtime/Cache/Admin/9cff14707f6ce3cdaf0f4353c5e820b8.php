			...
			<div class="main-content">
				<div class="container">
						...
						<div class="col-sm-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<form role="form" method="post" action="<?php echo U('Slide/post',array('type'=>$_GET['type']));?>" class="form-horizontal" enctype="multipart/form-data">
										<div class="form-group">
											<label class="col-sm-2 control-label">
												幻灯标题
											</label>
											<div class="col-sm-4">
												<input placeholder="请输入幻灯标题" name="title" value="<?php echo ($data["title"]); ?>" class="form-control" type="text">
											</div>
										</div>
                    <?php if(($_GET['type']) == "edit"): if(($data["pic"]) != ""): ?><div class="form-group">
                    	<div class="col-sm-4 col-sm-offset-2">
                    		<img src="/Uploads/<?php echo ($data["pic"]); ?>" width="200">
                      </div>
                    </div><?php endif; endif; ?>
                    <div class="form-group">
											<label class="col-sm-2 control-label">
                    ...
                    <div class="form-group">
											...
											<div class="col-sm-4">
												<input placeholder="请输入链接地址" name="url" value="<?php echo ($data["url"]); ?>" class="form-control" type="text">
											</div>
										</div>
                    <div class="form-group">
